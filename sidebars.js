  ...
  sidebar: [
    ...
    },
    {
      ...
      items: [
        {
          type: "category",
          label: "Midnight Developer Tutorial",
          link: { type: "doc", id: "develop/tutorial/index" },
          items: [
            {
              type: "category",
              label: "Part 1: Setting up Midnight",
            ...
            {
              type: "category",
              label: "Part 3: Creating a new DApp",
        ...
        },
        {
          type: "category",
          label: "Guides",
          items: ["develop/guides/wallet-dev-guide"]
        },
        {
          type: "category",
        ...
        },        
        {
          ...
          link: { type: "doc", id: "develop/reference/index" },
          items: [
            {
              type: "category",
              label: "The Compact Language",
              ...
              items: [
                ...
                "develop/reference/compact/explicit_disclosure",
                {
                  ...
                  items: [
                    "develop/reference/compact/compact-std-library/exports"
                  ]
                }
              ]
            },
              ...
              items: [
                {
                  ...
                  items: [
                    ...
                    },
                    {
                      ...
                      label: "Globals",
                      items: [
                        "develop/reference/midnight-api/compact-runtime/globals"
                      ]
                    },
                    {
                      type: "category",
                ...
                },
                {
                  ...
                  items: [
                    ...
                    },
                    {
                      ...
                      label: "Globals",
                      items: [
                        "develop/reference/midnight-api/dapp-connector/globals"
                      ]
                    },
                    {
                      type: "category",
    ...
    {
      type: 'category',
      label: 'Midnight Developer Academy',
      link: {
        type: 'doc',
        id: 'academy/index', // this is docs/academy/index.mdx
      },
      items: [
        {
          type: 'doc',
          id: 'academy/module-1',
          label: 'Module 1: Introduction to Blockchain Technology',
        },
        {
          type: 'doc',
          id: 'academy/module-2',
          label: 'Module 2: Cryptography and Smart Contracts',
        },
        {
          type: 'doc',
          id: 'academy/module-3',
          label: 'Module 3: Zero-Knowledge Proofs (ZKPs)',
        },
      ],
    },
  ]
