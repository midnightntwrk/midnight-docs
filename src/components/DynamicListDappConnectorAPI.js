...
const releases = [
  {
    ...
    artifacts: [
      { name: 'NPM Package', url: 'https://www.npmjs.com/package/@midnight-ntwrk/dapp-connector-api/v/3.0.0' },
    ],
  ...
  },
  {
    ...
    status: 'DEPRECATED',
    date: '2 April 2025',
    summary: 'Summary of 2.0.0',
    details: [
      "Bech32m Address format."
    ],
    artifacts: [
      { name: 'NPM Package', url: 'https://www.npmjs.com/package/@midnight-ntwrk/dapp-connector-api/v/2.0.0' },
    ],
  ...
  },
  {
    ...
    summary: 'Summary of 1.2.3',
    details: [
      "Package is now bundled as `cjs` and `esm` for wider runtime support."
    ],
    artifacts: [
      { name: 'NPM Package', url: 'https://www.npmjs.com/package/@midnight-ntwrk/dapp-connector-api/v/1.2.3' },
    ],
