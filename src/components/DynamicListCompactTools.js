...
const releases = [
  {
    ...
    artifacts: [
      { name: 'Compact developer tools', url: 'https://github.com/midnightntwrk/compact/releases/tag/compact-v0.3.0' }
    ],
  ...
  },
  {
    ...
    details: [
      'Compact developer tools self update',
      'Format subcommand'
    ],
    artifacts: [
      { name: 'Compact developer tools', url: 'https://github.com/midnightntwrk/compact/releases/tag/compact-v0.2.0' }
    ],
  ...
  },
  {
    ...
    artifacts: [
      { name: 'Compact developer tools', url: 'https://github.com/midnightntwrk/compact/releases/tag/compact-v0.1.0' }
    ],
