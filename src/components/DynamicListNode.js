...
const releases = [
  {
    ...
    details: [
      ...
      'Rust end to end tests framework (proof of concept).',
      'Add `dust-balance` command.',
      'Support input unshielded UTXOs when executing contracts.',
      'Add nonroot users to all Dockerfiles.',
      'Fix `register-dust-address` command when run on wallets with NIGHT token.',
