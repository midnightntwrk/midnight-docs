...
const releases = [
  {
    ...
    summary: 'Summary of Release 0.2.13',
    details: ['Bug fixes and updates.'],
    artifacts: [
      { name: 'VSIX Package', url: 'https://raw.githubusercontent.com/midnight-ntwrk/releases/gh-pages/artifacts/vscode-extension/compact-0.2.13/compact-0.2.13.vsix' },
    ],
    link: '/relnotes/vs-code-extension/vs-code-extension-0-2-13',
  },
  {
    id: 2,
    version: '0.2.12',
    status: 'DEPRECATED',
    date: '17 February 2024',
    summary: 'Summary of Release 0.2.12',
    details: ['Bug fixes and updates.'],
    artifacts: [
      { name: 'VSIX Package', url: 'https://raw.githubusercontent.com/midnight-ntwrk/releases/gh-pages/artifacts/vscode-extension/compact-0.2.12/compact-0.2.12.vsix' },
    ],
    link: '/relnotes/vs-code-extension/vs-code-extension-0-2-12',
  },
  {
    id: 3,
    version: '0.2.10',
    status: 'DEPRECATED',
    date: '17 February 2024',
    summary: 'Summary of Release 0.2.10',
    details: ['Bug fixes and updates.'],
    artifacts: [
      { name: 'VSIX Package', url: 'https://raw.githubusercontent.com/midnight-ntwrk/releases/gh-pages/artifacts/vscode-extension/compact-0.2.10/compact-0.2.10.vsix' },
    ],
    link: '/relnotes/vs-code-extension/vs-code-extension-0-2-10',
  },
];
