...
const releases = [
  {
    ...
    summary: 'Summary of Release 2.3.0',
    details: ['Updated ledger to version 3.0.6.', 'Memory leak has been addressed.'],
    artifacts: [
      { name: 'Docker Hub Image', url: 'https://hub.docker.com/r/midnightnetwork/midnight-pubsub-indexer/tags' },
    ],
    link: '/relnotes/pub-sub-indexer/pub-sub-indexer-2-3-0',
  },
];
