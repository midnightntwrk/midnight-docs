...
const releases = [
  {
    ...
    artifacts: [
      { name: 'Proof Server', url: 'https://hub.docker.com/r/midnightnetwork/proof-server/' },
    ],
    link: '/relnotes/proof-server/proof-server-4-0-0',
  },
  {
    id: 2,
    version: '3.0.7',
    status: 'DEPRECATED',
    date: '5 March 2025',
    summary: 'Summary of Release 3.0.7',
    details: [
    ...
    link: '/relnotes/proof-server/proof-server-3-0-7',
  },
  {
    id: 3,
    version: '3.0.6',
    ...
    link: '/relnotes/proof-server/proof-server-3-0-6',
  }
];
