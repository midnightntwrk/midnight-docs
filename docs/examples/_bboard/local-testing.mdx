...
title: "Midnight test environment"
description: "Learn how to run a Midnight test environment for the bulletin board DApp locally using Docker."
sidebar_position: 30
---
...
[start your proof server](../../guides/proof-server.mdx) again. When it is
