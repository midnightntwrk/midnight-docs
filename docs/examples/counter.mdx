...
Before working with the Counter example, ensure you have:
...
- Compact compiler toolchain installed
- Command-line familiarity

For more information, refer to the [Install the toolchain](../getting-started/installation) guide.

</details>

## Set up the example

This section walks you through the process of setting up and running the Counter DApp locally.
...
If you already have a wallet seed, select option `[2] Restore wallet from seed`.
...
The Counter example serves as a foundation for building more complex DApps. Consider these enhancements:
