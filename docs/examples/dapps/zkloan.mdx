...
- **Admin-controlled providers and blocklist**: only the holder of the admin secret can register attestation providers, blocklist accounts, or rotate the admin role to a new derived public key.
