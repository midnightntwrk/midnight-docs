...
- Node.js version 24.11.1 or higher (the repository pins it in `.nvmrc` and `engines`)
...
- **Build the contract yourself**: Learn how to [build the bulletin board smart contract](../../tutorials/bboard/smart-contract).
