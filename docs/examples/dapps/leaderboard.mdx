...
Clone the leaderboard repository and install dependencies:
...
If you prefer to build the project from scratch, follow the complete [Leaderboard tutorial](../../tutorials/leaderboard/overview).
