...
description: midnight_agent_skills is a set of 4 modular agent skills that give AI coding assistants accurate knowledge of Compact syntax, the Midnight SDK, network configuration, and common gotchas sourced from the developer community.
...
`midnight_agent_skills` is a set of 4 modular agent skills that fix this. Install them once, and your AI assistant has accurate knowledge of Compact syntax, the Midnight SDK, network configuration, and common gotchas sourced from the developer community.
...
The skills are built from the official Midnight documentation plus community articles from the Midnight Aliit Fellowship. They include:
...
`midnight_agent_skills` and [Midnight MCP](./midnight-mcp) solve the same problem from different angles.
