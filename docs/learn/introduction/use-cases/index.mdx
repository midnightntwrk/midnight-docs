...
-   Smart contracts are written in [Compact](/docs/learn/glossary.mdx#compact), a language based on [TypeScript](https://www.typescriptlang.org/)
-   A Microsoft Visual Studio Code plugin means that this free, powerful, familiar IDE can be used in development
-   Zero-knowledge proofs in Midnight use [ZK Snarks](/docs/learn/glossary.mdx#zk-snarks), a highly efficient form of ZK proof
