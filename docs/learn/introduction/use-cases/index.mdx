...
-   [Midnight smart contracts](/docs/develop/how-midnight-works/smart-contracts.mdx) can manage two states at once; a private [state](/docs/learn/glossary.mdx#state) on a local machine, and the public state that exists on the public blockchain
