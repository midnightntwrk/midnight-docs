...
For this, Midnight leverages [zero-knowledge (ZK) technology](../../understanding-midnights-technology/), a method that ensures privacy and security in digital interactions. [Zero-knowledge proofs (ZKPs)](/docs/learn/understanding-midnights-technology/zero-knowledge-proofs.mdx), a key application of ZK technology, enable one party to prove to another that a specific statement or claim is true without revealing any additional information beyond the claim itself.
...
Additionally, Midnight employs [ZK Snarks](/docs/learn/glossary.mdx#zk-snarks), a highly efficient form of ZKP, to facilitate secure transactions without revealing the identities of the transacting parties or transaction details.
...
[Zswap](/docs/learn/understanding-midnights-technology/zswap.mdx) transaction protocol and [Midnight smart contracts](../../../develop/how-midnight-works/smart-contracts.mdx). These protocols preserve confidential data and enable smart contract development methods that facilitate concurrency and security for transactions involving assets and the exchange of value. 
