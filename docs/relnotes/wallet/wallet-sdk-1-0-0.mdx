...
- [GitHub release: Wallet SDK 1.0.0](https://github.com/midnightntwrk/midnight-wallet/releases/tag/%40midnight-ntwrk%2Fwallet-sdk%401.0.0)
- [`@midnight-ntwrk/wallet-sdk` on npm](https://www.npmjs.com/package/@midnight-ntwrk/wallet-sdk/v/1.0.0)
