...
The updates below highlight the key features and improvements added in this release.
...
| `@midnight-ntwrk/wallet-sdk-shielded`   | 1.0.0   | Manages privacy-preserving shielded tokens. Handles ZK proof generation, coin commitment tracking, and encrypted output decryption.                                     |
