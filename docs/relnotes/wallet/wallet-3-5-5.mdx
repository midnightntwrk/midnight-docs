...
- Stopped using default values for the indexer URI.  
- Pinned TypeDoc plugin version to ensure consistency.  

### Upgrade Instructions

- Manually specify the indexer URI instead of relying on defaults.  
- Ensure the pinned TypeDoc plugin version is compatible with your documentation setup.  
