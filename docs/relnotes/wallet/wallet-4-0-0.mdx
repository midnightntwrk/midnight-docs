...
## Midnight Wallet SDK 4.0.0 release notes
...
Below is an overview of added features.
...
This section will guide on the steps to migrate to v4.0.0.
...
Then use `@midnight-ntwrk/wallet-sdk-hd@1.0.0-rc.1` and `@midnight-ntwrk/wallet-sdk-address-format@1.0.0-rc.1` if needed in your component.
