...
- Fixed a transaction history race condition by consolidating merge logic in the facade and delegating it to storage at construction time.
...
- [GitHub release: wallet-sdk-facade 4.0.0](https://github.com/midnightntwrk/midnight-wallet/releases/tag/%40midnight-ntwrk%2Fwallet-sdk-facade%404.0.0)
