...
This release delivers **Ledger 7.0** across Preview and PreProd environments, including runtime upgrades, SDK updates, tooling improvements, and supporting DApps.  
...
## Notes  
- Versions are aligned across **Preview** and **PreProd**  
