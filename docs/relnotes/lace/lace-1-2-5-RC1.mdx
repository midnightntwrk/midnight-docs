...
## Midnight Lace wallet 1.2.5 RC1 Release Notes
...
- Ensure compatibility with the bumped `dapp-connector-api` version.  
- Update integrations to work with the new Wallet SDK version.  

### Other Changes

- Bumped `dapp-connector-api` version.  
- Bumped Wallet SDK version.  
