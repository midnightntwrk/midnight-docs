...
The Indexer now supports D-Parameter and Terms & Conditions (T&C). Governance system parameters are exposed in the GraphQL API for easy access and monitoring.
