...
:::info Proof Server releases are now part of Ledger
Starting with Ledger 7.0.0, Proof Server releases are included as part of the [Ledger release](./ledger). For the most recent Proof Server releases and updates, please refer to the [release notes overview](./overview).
:::
...
[Link to related documentation](../guides/development-environment#run-the-proof-server)
