...
## Midnight 0.1.6 Example Applications release notes
...
- [DApp Examples (zip)](https://raw.githubusercontent.com/midnight-ntwrk/releases/gh-pages/artifacts/examples/midnight-examples-0.1.16.zip)
