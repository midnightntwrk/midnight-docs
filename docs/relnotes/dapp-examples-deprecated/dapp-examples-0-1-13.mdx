...
## Midnight 0.1.13 Example Applications release notes
...
- [DApp Examples (zip)](https://raw.githubusercontent.com/midnight-ntwrk/releases/gh-pages/artifacts/examples/midnight-examples-0.1.13.zip)
