...
## Midnight 0.2.2 Example Applications release notes
...
- [DApp Examples (zip)](https://raw.githubusercontent.com/midnight-ntwrk/releases/gh-pages/artifacts/examples/midnight-examples-0.2.2.zip)
