...
**Date:** 2026-01-28
**Environment:** any Midnight ledger 7 environment
...
The compiler needs to generates ZKIR code and prover and verifier keys for circuits that use the Midnight ledger.
