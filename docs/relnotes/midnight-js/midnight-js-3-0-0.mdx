...
**Required actions**:
- Add checks for empty Zswap state.
...
- Replace with string literals (e.g. `'preview'`).
...
- **Migration guide**: [Midnight preview migration guide](/develop/how-to/migrate-from-testnet-02-to-preview)
- **API reference**: [Midnight.js API documentation](../../develop/reference/midnight-api/midnight-js/packages)
