...
Midnight separates these concerns by keeping consensus on the public ledger layer, while private state and computation stay off-chain, verified through [zero-knowledge proofs](/concepts/zero-knowledge-proofs). Validators can agree on the chain's state without seeing private data. For how Midnight separates public and private state, see [keeping data private](/concepts/how-midnight-works/keeping-data-private), and for the broader landscape of privacy techniques, see [ZK vs FHE vs MPC](/concepts/zk-vs-fhe-vs-mpc).
...
| Delegated proof of stake (DPoS) | Token holders vote for a smaller set of delegates who produce blocks on their behalf | TRON |
