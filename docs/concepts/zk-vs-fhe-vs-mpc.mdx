...
To go deeper on Midnight's model, see [zero-knowledge proofs](/concepts/zero-knowledge-proofs) and the [glossary](/glossary). For the developer entry point, see the [Midnight Developer Hub](https://midnight.network/developer-hub).
