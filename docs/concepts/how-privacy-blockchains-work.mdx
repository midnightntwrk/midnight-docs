...
- **Confidential computing and trusted execution environments**: Oasis Sapphire, Secret Network, and Inco Lightning run confidential contracts inside hardware enclaves.
- **Fully homomorphic encryption**: Zama brings FHE smart contracts to Ethereum, and Fhenix is building an FHE coprocessor for EVM chains.
...
- [Zama documentation](https://docs.zama.org) and [Fhenix](https://www.fhenix.io): FHE platform references.
