...
The key technology that makes everything work is the [ZK Snark](../../glossary#zk-snarks).
...
translated in this way. See the [writing a contract](../../compact/reference/writing.mdx) section of this
