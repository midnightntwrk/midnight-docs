...
Docker Desktop is a graphical app, but it cannot run commands such as `docker compose`. It only provides the background Docker engine. All Midnight commands must be run in your system terminal.
