...
Midnight maintains public endpoints for two test networks, Preview and Preprod, and for the Mainnet production network. For the full per-network reference, including indexer, faucet, and proof server endpoints, see [Networks and environments](../guides/networks-and-environments).
