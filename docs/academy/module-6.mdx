...
1. Download the Compact compiler from the [Midnight release page](https://docs.midnight.network/relnotes/compact).
  ...
  <>
    ...
    <QuizWithRetry
      questions={[
        ...
        {
          question: 'What is the purpose of the `compactc --skip-zk` command?',
          options: [
