...
| Indexer | [4.4.0-rc.1](https://github.com/midnightntwrk/midnight-indexer) |
| Proof server | [9.0.0-rc.6](https://hub.docker.com/r/midnightntwrk/proof-server) |
...
| Compact.js | [2.5.5-rc.7](https://github.com/midnightntwrk/midnight-sdk/releases/tag/compact-js-v2.5.5-rc.6) |
| Midnight.js | [5.0.0-beta.6](https://github.com/midnightntwrk/midnight-js/releases/tag/v5.0.0-beta.4) |
