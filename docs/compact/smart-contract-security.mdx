...
See also [MPS-0029: Compact caller identity](https://github.com/midnightntwrk/midnight-improvement-proposals/blob/main/mps/mps-0029-compact-caller-identity.md) and the [Security best practices](/guides/security-best-practices) guide.
