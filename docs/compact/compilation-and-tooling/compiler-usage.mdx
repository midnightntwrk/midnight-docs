...
The Compact compiler, **compact compile**, takes as input a Compact source
...
**compact compile** compiles the source file and produces from it the following target files,
