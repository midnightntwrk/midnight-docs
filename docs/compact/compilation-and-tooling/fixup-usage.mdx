...
This document assumes you are using **fixup-compact** directly.
Typically, however, the fixup tool is invoked via the **compact** tool's `fixup`
...
The Compact fixup tool is part of Compact toolchain.
