...
_compactversion_ can be specified as a full version such as **0.30.1**, as a
...
format-compact tool.  _files_ can be individual `.compact` files or
...
reflect recent language changes.  _files_ can be individual `.compact`
