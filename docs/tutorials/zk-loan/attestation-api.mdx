...
:::note
If you are testing with [Midnight Local Dev](https://github.com/midnightntwrk/midnight-local-dev) instead of Preprod, skip this step. The local dev environment already includes a proof server on port `6300`.
:::
...
:::note
The proof server image version must match your SDK version. This tutorial uses `4.0.0`. Check the [Midnight documentation](https://docs.midnight.network) for the latest compatible version.
:::
