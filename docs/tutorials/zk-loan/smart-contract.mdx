...
Install the Midnight Compact compiler. Follow the instructions in [Midnight's documentation](https://docs.midnight.network/getting-started/installation) to install `compactc` on your system.
