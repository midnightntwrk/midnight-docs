...
This tutorial shows how to **deploy a Compact contract, call a circuit, and read contract state** from a small browser DApp. The DApp delegates chain sync, balancing, proving, and signing to an **injected wallet** (Lace or 1AM) through the DApp Connector API.
