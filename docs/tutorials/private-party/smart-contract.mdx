...
description: "Build a private party contract on Midnight that demonstrates the privacy boundary, Unshielded NIGHT tokens, and access control in Compact."
sidebar_position: 10
...
Open the project in your text editor and navigate to the `contract` directory before creating a new `.compact` file.
```bash
cd example-private-party/contract && touch private-party.compact
```
...
To inspect the full private-party repository, see [example-private-party](https://github.com/midnightntwrk/example-private-party). If you have questions, reach out in the Discord dev-chat channel.
