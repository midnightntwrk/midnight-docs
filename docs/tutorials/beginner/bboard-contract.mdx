...
description: "Learn how to build a bulletin board contract on Midnight Network."
sidebar_position: 30
---
...
[Visual Studio Code extension for Compact](../../compact/compilation-and-tooling/vscode-plugin.mdx),
...
[Running Midnight Compact compiler](../../compact/compilation-and-tooling/compiler-usage.mdx)
