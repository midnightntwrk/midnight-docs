...
5. **Register for DUST generation**: This step registers the wallet's NIGHT UTXOs with the DUST generation service. This is required for transaction fees on Preprod and Standalone networks.
