...
Install the required development dependencies. This installs the latest version of TypeScript required for the project configuration.
...
```json title="contract/tsconfig.json"
{
  "include": ["src/**/*.ts"],
  "compilerOptions": {
    "rootDir": "src",
...
```typescript title="contract/src/witnesses.ts"
...
```typescript title="contract/src/index.ts"
/**
...
```json title="contract/package.json"
{
