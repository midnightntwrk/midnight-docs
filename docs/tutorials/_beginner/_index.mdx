...
description: "Learn how to install and setup the tools needed to build a DApp on Midnight Network."
sidebar_position: 10
---
...
This command downloads and installs Node.js 22. LTS versions receive critical bug fixes and security updates for an extended period, ensuring stability for production applications. The installation includes both Node.js and npm.

Set Node 22 as the default version for new terminal sessions:
