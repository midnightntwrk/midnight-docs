...
description: Frequently asked questions about Midnight Network.
sidebar_label: FAQ
sidebar_position: 5
tags: [faq]
---
...
Find answers to common questions about the Midnight Network, development tools, and troubleshooting. If you cannot find the answer you need, see the [getting help](./getting-help) page for additional support resources.
...
Visit the [token acquisition page](../guides/acquire-tokens.mdx) to find out more.
...
The [Getting help](./getting-help) section of this site describes
...
See [Midnight's architecture](../concepts/how-midnight-works/midnight-combined-model.mdx)
and the section of this site about [How Midnight works](../concepts/).
