...
This page outlines the levers and responsibilities that govern DUST economics. This is a Preview-stage overview; specific processes and parameters will be finalized closer to Mainnet.

## Scope of governance

- **DUST parameters:** NIGHT-to-DUST ratio, rate of generation/decay (as a multiple of NIGHT holdings), grace period for DUST spends to stay valid.
...
Wallets and DApps should query live parameters through the node or Indexer API rather than hardcoding values.
