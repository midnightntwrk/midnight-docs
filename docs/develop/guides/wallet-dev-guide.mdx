...
The Midnight wallet SDK can connect to different networks. Below are the currently supported environments:

| Network          | RPC URL                                   | Explorer (temporary) |
|------------------|-------------------------------------------|-----------------------|
| Testnet 02       | https://rpc.testnet-02.midnight.network   | https://explorer.testnet-02.midnight.network |
| Preview Testnet  | https://rpc.preview.midnight.network/     | [Polkadot.js Explorer](https://polkadot.js.org/apps/?rpc=wss%3A%2F%2Frpc.preview.midnight.network#/explorer) |
...
<Tabs groupId="midnight-network" defaultValue="testnet02" values={[
  {label: 'Testnet-02', value: 'testnet02'},
  {label: 'Preview Testnet', value: 'preview'},
]}>

<TabItem value="testnet02">
...
const wallet = await WalletBuilder.build(
  'https://indexer.preview.midnight.network/api/v1/graphql', // Indexer URL
  'wss://indexer.preview.midnight.network/api/v1/graphql/ws', // Indexer WebSocket URL
  'http://localhost:6300', // Proving Server URL
