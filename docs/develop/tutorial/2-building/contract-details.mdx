---
sidebar_label: "2.4 In detail: the counter contract"
---
...
Midnight examples directory at:
...
[Visual Studio Code extension for Compact](../building),
you might want to open the preceding file in VS Code to follow along.
