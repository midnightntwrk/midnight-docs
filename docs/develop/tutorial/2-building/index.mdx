...
:::important
Use compatible versions of example code and the Compact compiler, as shown in the [release compatibility matrix](../../../relnotes/comp-matrix).
:::
...
The version number corresponds to the Compact compiler release, not the developer tools version. These versions are independent—developer tools version 0.1.0 might manage compiler version 0.24.0. Refer to the [release compatibility matrix](../../../relnotes/comp-matrix) for version compatibility between compiler versions and example code.
