...
This command will display the version number of your installed compiler, such as `0.8.11`, confirming that it's properly installed and ready to use. Refer to the [release compatibility matrix](../../../relnotes/comp-matrix) for the version compatibillity overview.
...
`COMPACT_HOME` to locate the Compact compiler.  You may want to add
...
You may also want to add the directory to your `PATH` environment variable.
...
of them.  Even if VSCode is not your primary editor, you may want to
