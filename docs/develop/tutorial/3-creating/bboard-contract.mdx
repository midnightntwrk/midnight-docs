...
<CodeFromGithub
  url="https://github.com/midnightntwrk/example-bboard/blob/main/contract/src/bboard.compact#L35-L40"
  language="compact"
/>
...
<CodeFromGithub
  url="https://github.com/midnightntwrk/example-bboard/blob/main/contract/src/bboard.compact#L53-L55"
  language="compact"
/>
...
<CodeFromGithub
  url="https://github.com/midnightntwrk/example-bboard/blob/main/contract/src/bboard.compact#L33"
  language="compact"
/>
...
<CodeFromGithub
  url="https://github.com/midnightntwrk/example-bboard/blob/main/contract/src/bboard.compact#L42-L51"
  language="compact"
/>
...
ompile the `bboard.compact` with the Compact compiler
