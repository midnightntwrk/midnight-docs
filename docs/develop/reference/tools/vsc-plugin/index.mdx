...
The [Visual Studio Code](https://code.visualstudio.com/) extension for Compact is a plugin
  ...
  "tasks": [
    {
      ...
      "type": "shell",
      "command": "npx compactc --vscode --skip-zk ${file} ${workspaceFolder}/src/managed",
      "group": "build",
      "presentation": {
        "echo": true,
        "reveal": "never",
