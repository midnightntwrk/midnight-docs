...
# Step 2. Configure Partner-Chains Dependencies
...
## 2a. Set Up Dependencies with Docker Compose
...
### 2. Clone the `Midnight-node-docker` Repository
...
### 4. Start Partner-Chains Dependency Services
...
### 2b. Manage and monitor services:
