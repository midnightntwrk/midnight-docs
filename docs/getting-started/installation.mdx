...
Get started with Midnight, whether you are here to use privacy-preserving applications or to build them. The installation process includes setting up the Lace Midnight Prevew wallet, obtaining test tokens (tDUST) and configuring the development environment.
...
:::note
The Lace Midnight Preview wallet is specific to Midnight testnet (also known as preview). The standard Lace wallet for mainnet _will not work_ for testing Midnight*
:::
...
<StepsProvider>
    ...
    <Step>Install the Lace wallet extension from the Chrome Web Store: https://chromewebstore.google.com/detail/lace-beta/hgeekaiplokcnmakghbdfbgnlfheichg.</Step>
...
<StepsProvider>
    ...
    <Step>Navigate to the Testnet Faucet: [https://midnight.network/test-faucet/](https://midnight.network/test-faucet/).</Step>
...
If you don't have Docker, [download and install Docker](https://www.docker.com/products/docker-desktop/) for your operating system (macOS, Windows, or Linux):
