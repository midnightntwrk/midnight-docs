...
:::note
To access the Midnight wallet, first create a Cardano wallet, then go to settings and after that you can add a new wallet and choose the Midnight network.
:::
