...
<StepsProvider>
    ...
    <Step>Copy the seed phrase to your clipboard and click **Next** to continue.</Step>
    ...
    <Step>Paste the seed phrase into the confirmation field and click **Confirm** to complete the setup.</Step>
    <Step>Next, enter your wallet name, choose a strong password, and click **Next** to continue.</Step>
    ![Wallet name](./img/wallet-name-password.png)

    <Step>Finally, choose your network and proof server address. Then click **Enter wallet** to complete the setup.</Step>
...
<StepsProvider>
    <Step>In your Lace wallet, click **Receive** and copy your Unshielded wallet address.</Step>
    ![Unshielded wallet address](./img/copy-unshielded-address.png)
    <Step>Then, go to the Preprod Faucet: https://faucet.preprod.midnight.network/.</Step>
    <Step>Paste your address into the form and click **Request tokens**. You'll need to wait a few minutes for the tokens to arrive.</Step>
    <Step>Once the tokens are received, you'll need to delegate them to your wallet to generate tDUST. Click **Generate tDUST** and select your wallet address.</Step>
    ![tDUST balance](../guides/img/delegate-dust.png)
    <Step>Then click **Review transaction** to proceed and select **Confirm** to submit the transaction.</Step>
...
This section covers common issues you may encounter during installation and their solutions.
