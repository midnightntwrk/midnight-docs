...
You can compile the contract from your project root directory:

```bash
compact compile contracts/hello-world.compact contracts/managed/hello-world
```

Alternatively, navigate to the `contracts/` folder first and then compile:
...
This generates artifacts in a managed subdirectory structure. You can see the generated structure with:
...
- The `managed/hello-world/` directory: This contains all artifacts for your specific contract, organized in a managed structure that scales well when you have multiple contracts.
