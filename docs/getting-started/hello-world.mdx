...
The `ledger` line defines on-chain state variables that persist on the blockchain. This is where you declare what data your contract will store.
...
3. For details on installing the Compact toolchain, refer to the [installation guide](./installation).
...
For more information, refer to the [deploy your contract](../guides/deploy-mn-app) guide.