...
Continue from the Hello World contract creation and deploy a compiled contract to Midnight Testnet.
...
Hello World contract is now live on Midnight Testnet. Continue to next documentation for interacting with deployed contract.