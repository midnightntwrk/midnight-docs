...
This guide will show how a user can run the proof server locally in order
...
**This guide is aimed at Midnight Network users, not DApp builders.**
...
New users may need to setup an account.
