...
description: Install Docker, the Compact compiler, the VS Code extension, and a local proof server on macOS, Linux, or Windows (WSL), with optional Bun setup.
...
5. Confirm the installation and check that the toolchain is current:
