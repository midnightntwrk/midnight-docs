...
Midnight SDK packages ship WASM modules (via wasm-bindgen) that require specific Vite configuration. Without this step, your app will render a blank page in development or fail with `Cannot access '__wbindgen_start' before initialization`.
