...
description: Build a wallet connection flow with the Midnight DApp Connector API in a Vite + React or Next.js application, from discovery to a connected address.
sidebar_label: "Connect a wallet from your frontend"
sidebar_position: 6
tags: [wallet, react, nextjs, dapp-connector, tutorial]
...
- Check that your browser has a Midnight wallet extension installed and enabled.
...
- Make sure you have unlocked and synced the wallet.
...
- **Display balances**: Show token balances for different assets.
