...
It also covers extracting data from these blocks using the Polkadot API and the various methods it provides to connect to Substrate-based blockchain networks.
...
The [`@polkadot/api`](https://polkadot.js.org/docs/api/) library includes a WebSocket provider (`WsProvider`) to connect to Substrate-based blockchain networks, including Midnight.
