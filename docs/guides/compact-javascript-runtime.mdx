...
description: "Run a Compact contract's logic from JavaScript: implement witnesses, call circuits, write unit tests, and read the generated module's exports and errors."
