...
- [ ] **Decide your upgrade-key custody.** If the contract is upgradeable, distribute control across independent parties. See [Contract updatability and the maintenance authority](./deploy-and-operate#contract-updatability-and-the-maintenance-authority).
...
- [Deploying and operating a contract](./deploy-and-operate): wiring the indexer and private-state providers your DApp uses, and maintaining the contract after deployment.
