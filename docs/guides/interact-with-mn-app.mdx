...
Before each menu, the CLI shows your current DUST balance. DUST is required for transaction fees, 
so it helps you monitor whether you have enough to perform operations.
