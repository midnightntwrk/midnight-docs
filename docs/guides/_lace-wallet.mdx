...
<StepsProvider>
    ...
    <Step>Go to the Preprod Faucet: https://midnight-tmnight-preprod.nethermind.dev/.</Step>
...
At this point, the Lace wallet displays a balance of tokens for interacting with testnet DApps. In order to process transactions, Lace requires a proof server to be running on your machine. Follow the [proof server guide](./proof-server) to get it up and running.
