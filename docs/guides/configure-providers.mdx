...
- Docker installed and running. This is required to run the [proof server](./development-environment#run-the-proof-server) and generate zero-knowledge (ZK) proofs.
