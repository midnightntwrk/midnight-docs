...
Now, you've deployed your contract to Preprod. See the [interact with hello world contract](./interact-with-mn-app) guide to build a CLI and call the `storeMessage` circuit.
