...
1. In the Lace wallet extension, click the **Settings** icon and select the **Network** tab. 
2. Under the Midnight section, select the **Undeployed** network and click **Confirm**.
