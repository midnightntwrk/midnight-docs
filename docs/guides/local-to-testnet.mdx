...
- Work with the JavaScript implementation of your contract: implement witnesses, call circuits, and write unit tests. See [the Compact JavaScript implementation](./compact-javascript-runtime).
