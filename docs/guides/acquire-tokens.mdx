...
:::tip
If you are using the local undeployed network, use the [local network faucet](./midnight-local-network#get-faucet-tokens) to fund your wallet and generate tDUST.
:::
...
2. Visit [Midnight preprod faucet](https://faucet.preprod.midnight.network/) and enter your Unshielded wallet address.
