...
Existing Compact code remains functional but required recompilation and redeployment to align with the BLS12-381 standard. The transition to BLS12-381 paved the way for a significantly more performant developer experience with faster transactions.

👉 **For support, join the Midnight [Discord](https://discord.com/invite/midnightnetwork)!**
