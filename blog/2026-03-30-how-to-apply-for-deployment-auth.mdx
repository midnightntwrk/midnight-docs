...
Deployment on the Midnight network during this [phase](https://x.com/MidnightNtwrk/status/2038617317634961904) is open to applications that meet the risk self evaluation rubric. This guide explains how to assess your DApp and understand the risk before moving forward.
...
Deployment proposals are submitted as Pull Requests to the [Midnight Improvement Proposals repository](https://github.com/midnightntwrk/midnight-improvement-proposals).
