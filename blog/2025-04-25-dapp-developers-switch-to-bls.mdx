...
You can use the same method to deploy contracts as you are used to, or you can take a look at the maintained [`example-bboard`](https://github.com/midnightntwrk/example-bboard) starter (or scaffold with [`create-mn-app`](https://github.com/midnightntwrk/create-mn-app) `--template bboard`) and its deploy helpers. The older [`example-counter`](https://github.com/midnightntwrk/example-counter) repository is archived.  
