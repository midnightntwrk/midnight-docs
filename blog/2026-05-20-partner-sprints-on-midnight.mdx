...
title: How Midnight Navigates Van Rossem Hard Fork
authors: stev
tags: [blockchain, hardforks, upgrades]
date: 2026-05-20
image: /img/blog/blockchain.jpg
---

# How Midnight Navigates Cardano Van Rossem Hard Fork

As a data-protection partner chain, Midnight is intrinsically tethered to Cardano. This close relationship provides incredible security and interoperability, but it also means that when Cardano undergoes a major evolution, Midnight must move in lockstep.
...
:::important
Because the Van Rossem Hard Fork requires a state replay, a parallel Cardano stack method is required if service downtime is a concern. Federated Node Operators, faucets, RPCs, or other very important running services in the ecosystem should approach the Van Rossem Hard Fork through a parellel Cardano Stack to minimize downtime.
:::

**The Big Takeaway:** Minimizing downtime isn't just about preserving an individual node's uptime metrics; it’s about maintaining the health, throughput, and decentralized integrity of the entire Midnight network while Cardano beaneth the surface evolves.