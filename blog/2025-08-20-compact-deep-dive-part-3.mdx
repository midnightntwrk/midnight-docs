...
`Op` is a type [defined](api-reference/onchain-runtime/type-aliases/Op) in the on-chain runtime.
Transactions will use a [binary encoding](/concepts/how-midnight-works/impact#programs) of these instructions.
