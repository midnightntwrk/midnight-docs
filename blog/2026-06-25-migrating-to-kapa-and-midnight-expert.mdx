...
The first is the [Kapa](https://www.kapa.ai/) MCP server. It's the same Midnight knowledge base that already answers questions behind the "Ask AI" button on these docs, now exposed over MCP so your editor can query it directly. It takes over the search and question-answering side of the old server.
