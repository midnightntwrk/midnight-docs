...
title: "Migrating to the Kapa MCP server and Midnight Expert"
description: "The Midnight MCP server is being retired. Here is how to move to the Kapa MCP server for documentation search and Midnight Expert for hands-on Midnight development."
authors: aaron
