...
The articles assume that you are familiar with Compact to the level of detail covered in the [developer tutorial](/category/tutorials).
...
We'll use our old favorite, [Bulletin Board](/tutorials/bboard/smart-contract) as an example.
We're compiling this with Compact toolchain version 0.24.0.
The Compact language is a moving target as we introduce and change features, so this code may not compile with any Compact toolchain version other than 0.24.0.
:::note 
...
Remember, this was generated with Compact toolchain version 0.24.0.
...
The API documentation for the Compact runtime is available in the [Compact runtime](/api-reference/compact-runtime/) API reference.
...
This function takes a value of the Compact runtime’s type [`StateValue`](/api-reference/compact-runtime/classes/StateValue).
...
This is an interface declared in the [Compact runtime](/api-reference/compact-runtime/interfaces/CircuitContext).
...
This is another interface declared in the [Compact runtime](/api-reference/compact-runtime/interfaces/CircuitResults).
...
This interface is declared in the [Compact runtime](/api-reference/compact-runtime/interfaces/WitnessContext).
