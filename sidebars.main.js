...
module.exports = {
  sidebar: [
    // GET STARTED
    {
      ...
      label: "Get started",
      items: [
        { type: "doc", id: "getting-started/installation", label: "Get started" },
        { type: "doc", id: "getting-started/create-mn-app", label: "Create an MN app" },
        { type: "doc", id: "getting-started/deploy-mn-app", label: "Deploy an MN app" },
        { type: "doc", id: "getting-started/interact-with-mn-app", label: "Interact with an MN app" },
      ],
    },
    ...
    // WHAT IS MIDNIGHT
    {
      ...
      items: [
        ...
        },
        {
          type: "category",
          label: "Use cases",
          link: { type: "doc", id: "learn/introduction/use-cases" },
          items: [
          ],
        },
        {
        ...
        "learn/introduction/wallets",
        { type: "doc", id: "learn/resources", label: "Additional resources" },
      ],
    },
    ...
    // CONCEPTS
    {
      ...
      items: [
        ...
        },
        {
          type: "category",
          label: "Architecture",
          link: { type: "doc", id: "develop/how-midnight-works" },
          items: [
      ...
      items: [
        {
          ...
          link: { type: "doc", id: "develop/tutorial/using" }, // no /index
          items: [
          ],
        },
        {
          ...
          items: [
            {
              ...
              link: { type: "doc", id: "develop/tutorial/building" }, // no /index
              items: [
              ],
            },
            {
              ...
              link: { type: "doc", id: "develop/tutorial/creating" }, // no /index
              items: [
              ],
            },
          ],
    ...
    // HOW-TO
    {
      ...
      collapsed: true,
      items: [
        { type: "doc", id: "develop/guides/wallet-dev-guide", label: "Implement wallet functionality" },
        { type: "doc", id: "develop/how-to/handle-private-state-sessions", label: "Handle private state sessions" },
        { type: "doc", id: "develop/how-to/react-wallet-connect", label: "Create a React Wallet Connector" },
        { type: "doc", id: "develop/how-to/nextjs-wallet-connect", label: "Create a NextJs Wallet Connector" },
        { type: "doc", id: "develop/how-to/verify-private-data", label: "Verify private data" },
        { type: "doc", id: "develop/how-to/fix-version-mismatch-errors", label: "Fix version mismatch errors" },
        { type: "doc", id: "develop/how-to/write-nft-contract", label: "Write NFT contracts" },
        { type: "doc", id: "develop/how-to/fix-package-repository-access-failures", label: "Fix Package Repository Issue" },
        {
          type: "category",
      ...
      items: [
        {
          ...
          link: { type: "doc", id: "validate/run-a-validator" }, // no /index
          items: [
        ...
        },
        {
          ...
          link: { type: "doc", id: "validate/tutorials" }, // no /index
          items: [],
        },
      ],
    },
    ...
    // API DOCUMENTATION
    {
      ...
      collapsed: true,
      link: { type: "doc", id: "develop/reference/midnight-api" }, // no /index
      items: [
        // Compact runtime API
        {
          type: "category",
          label: "Compact runtime API",
          link: { type: "doc", id: "develop/reference/midnight-api/compact-runtime/README" },
          items: [
            { type: "category", label: "Classes", items: [
            ...
            { type: "category", label: "Enumerations", items: [
              "develop/reference/midnight-api/compact-runtime/enumerations/NetworkId",
            ]},
            { type: "category", label: "Functions", items: [
            ...
            { type: "category", label: "Globals", items: [
              "develop/reference/midnight-api/compact-runtime/globals",
            ]},
            { type: "category", label: "Interfaces", items: [
            ...
            { type: "category", label: "Type aliases", items: [
            ...
            { type: "category", label: "Variables", items: [
        ...
        // DApp connector API
        {
          ...
          link: { type: "doc", id: "develop/reference/midnight-api/dapp-connector/README" },
          items: [
            { type: "category", label: "Classes", items: [
        ...
        // Ledger API
        {
          type: "category",
          label: "Ledger API",
          link: { type: "doc", id: "develop/reference/midnight-api/ledger/README" },
          items: [
            { type: "category", label: "Classes", items: [
            ...
            { type: "doc", id: "develop/reference/midnight-api/ledger/globals", label: "Globals" },
            { type: "category", label: "Type aliases", items: [
        ...
        // Midnight.js API
        {
          ...
          link: { type: "doc", id: "develop/reference/midnight-api/midnight-js/README" },
          items: [
            {
              type: "category",
              ...
              items: [
                {
                  ...
                  link: { type: "doc", id: "develop/reference/midnight-api/midnight-js/@midnight-ntwrk/midnight-js-contracts/README" },
                  items: [{ type: "autogenerated", dirName: "develop/reference/midnight-api/midnight-js/@midnight-ntwrk/midnight-js-contracts" }],
                },
                {
                  type: "category",
                  label: "midnight-js-utils",
                  link: { type: "doc", id: "develop/reference/midnight-api/midnight-js/@midnight-ntwrk/midnight-js-utils/README" },
                  items: [{ type: "autogenerated", dirName: "develop/reference/midnight-api/midnight-js/@midnight-ntwrk/midnight-js-utils" }],
                },
                {
                  type: "category",
                  label: "midnight-js-types",
                  link: { type: "doc", id: "develop/reference/midnight-api/midnight-js/@midnight-ntwrk/midnight-js-types/README" },
                  items: [{ type: "autogenerated", dirName: "develop/reference/midnight-api/midnight-js/@midnight-ntwrk/midnight-js-types" }],
                },
                {
                  type: "category",
                  label: "midnight-js-fetch-zk-config-provider",
                  link: { type: "doc", id: "develop/reference/midnight-api/midnight-js/@midnight-ntwrk/midnight-js-fetch-zk-config-provider/README" },
                  items: [{ type: "autogenerated", dirName: "develop/reference/midnight-api/midnight-js/@midnight-ntwrk/midnight-js-fetch-zk-config-provider" }],
                },
                { type: "doc", id: "develop/reference/midnight-api/midnight-js/packages", label: "Packages" },
              ],
            },
          ],
        },
        ...
        // On-chain runtime API
        {
          ...
          link: { type: "doc", id: "develop/reference/midnight-api/onchain-runtime/README" },
          items: [
            { type: "category", label: "Classes", items: [
            ...
            { type: "doc", id: "develop/reference/midnight-api/onchain-runtime/globals", label: "Globals" },
            { type: "category", label: "Type aliases", items: [
        ...
        // Midnight indexer API
        {
          ...
          link: { type: "doc", id: "develop/reference/midnight-api/midnight-indexer/README" },
          items: [],
        },
        ...
        // Wallet API
        {
          type: "category",
          label: "Wallet API",
          link: { type: "doc", id: "develop/reference/midnight-api/wallet-api/README" },
          items: [
            { type: "doc", id: "develop/reference/midnight-api/wallet-api/globals", label: "Globals" },
            { type: "category", label: "Interfaces", items: [
        ...
        // ZSwap API
        {
          type: "category",
          label: "ZSwap API",
          link: { type: "doc", id: "develop/reference/midnight-api/zswap/README" },
          items: [
            { type: "category", label: "Classes", items: [
            ...
            { type: "doc", id: "develop/reference/midnight-api/zswap/globals", label: "Globals" },
            { type: "category", label: "Type aliases", items: [
    ...
    // TROUBLESHOOTING
    {
      ...
      collapsed: true,
      items: [
        { type: "doc", id: "develop/faq", label: "Frequently asked questions" },
        { type: "doc", id: "develop/getting-help", label: "Getting help" },
      ],
    },
    ...
    // RELEASE NOTES
    {
      ...
      label: "Release notes",
      collapsed: true,
      link: { type: "doc", id: "relnotes/overview" },
      items: [
        { type: "doc", id: "relnotes/ledger", label: "Ledger" },
        { type: "doc", id: "relnotes/proof-server", label: "Proof server" },
        { type: "doc", id: "relnotes/onchain-runtime", label: "Onchain runtime" },
        { type: "doc", id: "relnotes/node", label: "Node" },
        { type: "doc", id: "relnotes/midnight-indexer", label: "Midnight indexer" },
        { type: "doc", id: "relnotes/lace", label: "Midnight Lace wallet" },
        { type: "doc", id: "relnotes/wallet", label: "Wallet SDK" },
        { type: "doc", id: "relnotes/midnight-wallet-api", label: "Wallet API" },
        { type: "doc", id: "relnotes/dapp-connector-api", label: "DApp connector API" },
        { type: "doc", id: "relnotes/faucet", label: "Faucet" },
        { type: "doc", id: "relnotes/compact", label: "Compact compiler" },
        { type: "doc", id: "relnotes/compact-tools", label: "Compact developer tools" },
        { type: "doc", id: "relnotes/midnight-js", label: "Midnight.js" },
        { type: "doc", id: "relnotes/vs-code-extension", label: "VS Code extension" },
        { type: "doc", id: "relnotes/support-matrix", label: "Compatibility matrix" },
      ],
    },

    // GLOSSARY
    { type: "doc", id: "learn/glossary", label: "Glossary" },

    // DEV DIARIES LINK
    { type: "link", label: "Dev diaries", href: "/blog" },
  ],
};
