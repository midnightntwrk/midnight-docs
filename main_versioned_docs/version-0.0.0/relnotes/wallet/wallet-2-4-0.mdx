...
- Fixed auth errors and updated preset in Tullia tasks.
- Improved `NotSufficientFunds` error message.

### Upgrade Instructions

- Updated the state before submitting a transaction.
