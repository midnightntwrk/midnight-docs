...
## Wallet 3.6.0 RC14 Release Notes
...
- Attempted to restore the `compile -> update downloadLedgerBinaries` process.  
- Increased proving timeout.  

### Upgrade Instructions

- Ensure that the updated proving timeout aligns with system requirements.  
- Verify that the `downloadLedgerBinaries` update functions correctly in the compilation process.  