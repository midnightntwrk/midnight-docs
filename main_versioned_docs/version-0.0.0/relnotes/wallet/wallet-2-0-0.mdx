...
- Linked new `Wallet-API` and `Ledger-API`.
- Added option to create a wallet with an initial state.

### Upgrade Instructions

- Ensure compatibility with the new `Wallet-API` and `Ledger-API` integration.