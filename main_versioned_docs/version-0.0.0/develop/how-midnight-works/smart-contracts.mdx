...
The key technology that makes everything work is the [ZK Snark](/learn/glossary#zk-snarks).
...
translated in this way. See the [writing a contract](../reference/compact/writing.mdx) section of this
