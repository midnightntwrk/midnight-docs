...
[Visual Studio Code extension for Compact](../2-building/index.mdx#optional-visual-studio-code-vscode-extension-for-compact),
...
[Running Midnight Compact compiler](../2-building/index.mdx#running-midnight-compact-compiler)
