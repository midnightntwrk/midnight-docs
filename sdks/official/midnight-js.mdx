...
- [Docker](https://www.docker.com/) installed and running (required for the [proof server](../../guides/development-environment#run-the-proof-server)).
...
For more information, see the [Midnight local network](../../guides/local-to-testnet#local-network) guide.
