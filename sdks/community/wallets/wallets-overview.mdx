...
- **Overview:** Input Output's multi-chain wallet (Cardano, Bitcoin, Midnight). For Midnight it is a Chrome and Edge extension, not the Lace mobile app. ([lace.io/midnight](https://www.lace.io/midnight), [docs](https://docs.midnight.network/getting-started/installation), [GitHub](https://github.com/input-output-hk/lace))
- **Supports:**
  - NIGHT management.
