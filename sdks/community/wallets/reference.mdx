...
- [React wallet-connect guide](https://docs.midnight.network/guides/connect-wallet-frontend)
...
**Lace**
- [Lace Midnight page](https://www.lace.io/midnight); [Lace wallet guide](https://docs.midnight.network/getting-started/installation)
