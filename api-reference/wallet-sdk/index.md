...
description: API reference for the Midnight Wallet SDK covering the facade, HD key derivation, address encoding, transfers, DUST management, and atomic swaps.
