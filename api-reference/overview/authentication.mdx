...
description: Learn about the authentication methods for deploying and interacting with smart contracts in Midnight.
sidebar_position: 20
...
The [Midnight.js](/sdks/official/midnight-js) package enables you to deploy contracts and interact with them. To configure providers, you need to create a `MidnightProviders` object. This object defines the providers for submitting transactions and interacting with contracts.
...
The provider implementation above is for demonstration and intentionally omits some configuration. For the full provider configuration, see the [Midnight.js](/sdks/official/midnight-js) documentation.
