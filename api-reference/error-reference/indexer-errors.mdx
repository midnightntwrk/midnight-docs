...
| Message | Description | Fix |
|---------|---------|-----|
| `"invalid address"` | The supplied address (unshielded, shielded, or DUST) failed Bech32m decode or HRP validation. | Verify the address format. For expected HRP prefixes, see the [Address format errors](#address-format-errors) section. |
