...
#### [<code style={{ fontWeight: 'normal' }}><b>TermsAndConditionsChange</b></code>](/midnight-indexer/types/objects/terms-and-conditions-change.mdx) <Badge class="badge badge--secondary " text="object"/>
