...
#### [<code style={{ fontWeight: 'normal' }}><b>DParameterChange</b></code>](api-reference/midnight-indexer/types/objects/dparameter-change.mdx) <Badge class="badge badge--secondary " text="object"/>
